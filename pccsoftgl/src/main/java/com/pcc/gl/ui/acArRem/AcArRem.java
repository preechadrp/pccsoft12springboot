...
import com.pcc.gl.progman.ManAcArRem;
...
public class AcArRem extends FWinMenu {
	...
	public void onClick_btnPrint(int print_option) {
		...
		try {
			...
			ManAcArRem.getReport(this.getLoginBean(), FnDate.getSqlDate(tdbToPostdate.getValue()),
