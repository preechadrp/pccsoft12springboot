package com.pcc.gl.ui.acApClear;
...
import com.pcc.gl.progman.ManAcApClear;
...
public class AcApClear extends FWinMenu {
	...
	public void onClick_btnFind() {
		try {
			...
			ManAcApClear.getDataQry(lst_gl_header, txtVOU_TYPE.getValue(), txtVOU_NO.getValue(), txtDOCNO.getValue(),
					this.getLoginBean());
