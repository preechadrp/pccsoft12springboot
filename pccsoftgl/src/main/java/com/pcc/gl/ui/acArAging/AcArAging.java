package com.pcc.gl.ui.acArAging;
...
import com.pcc.gl.progman.ManAcArAging;
...
public class AcArAging extends FWinMenu {
	...
	public void onClick_btnPrint(int print_option) {
		...
		try {
			...
			ManAcArAging.getReport(this.getLoginBean(), FnDate.getSqlDate(tdbToPostdate.getValue()),
