...
public class AcPayAp extends FWinUtil {
	...
	public void onClick_btnSave() {
		...
		try {
			...
			ManAcEntr.addPayAp(this.lst_select, this.acgl_header, this.getLoginBean());
	...
	public void onClick_btnFind() {
		...
		try {
			...
			ManAcEntr.findAp(txtCUST_CDE.getValue(), txtDOCNO.getValue(), tdbPOSTDATE_FROM.getValue(),
