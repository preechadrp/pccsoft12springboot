...
import com.pcc.gl.progman.ManAcApRem;
...
public class AcApRem extends FWinMenu {
	...
	public void onClick_btnPrint(int print_option) {
		...
		try {
			...
			ManAcApRem.getReport(this.getLoginBean(), FnDate.getSqlDate(tdbToPostdate.getValue()),
