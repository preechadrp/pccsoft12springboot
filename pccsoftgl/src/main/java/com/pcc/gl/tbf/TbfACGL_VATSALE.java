...
public class TbfACGL_VATSALE {
	public static boolean insert(TboACGL_VATSALE model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return insert(dbc, model);
		}
	}

	public static boolean insert(FDbc dbc, TboACGL_VATSALE model) throws SQLException, Exception {
	...
	public static boolean update(TboACGL_VATSALE model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return update(dbc, model);
		}
	}

	public static boolean update(FDbc dbc, TboACGL_VATSALE model) throws SQLException, Exception {
	...
	public static boolean update(TboACGL_VATSALE model, String fixWhere) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return update(dbc, model, fixWhere);
		}
	}

	public static boolean update(FDbc dbc, TboACGL_VATSALE model, String fixWhere) throws SQLException, Exception {
	...
	public static boolean delete(TboACGL_VATSALE model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return delete(dbc, model);
		}
	}

	public static boolean delete(FDbc dbc, TboACGL_VATSALE model) throws SQLException, Exception {
	...
	public static boolean find(TboACGL_VATSALE model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return find(dbc, model);
		}
	}

	public static boolean find(FDbc dbc, TboACGL_VATSALE model) throws SQLException, Exception {
	...
	public static PreparedStatement getPrepareStmInsert(FDbc dbc) throws SQLException, Exception {
		...
		sql.append(" INSERT INTO ").append(TboACGL_VATSALE.tablename).append("(");
		sql.append(" POSTDATE,");
		sql.append(" TAX_TYPE,");
	...
	public static PreparedStatement getPrepareStmUpdate(FDbc dbc, String fixWhere) throws SQLException, Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" UPDATE ").append(TboACGL_VATSALE.tablename).append(" SET ");
		sql.append(" POSTDATE=?,");
		sql.append(" TAX_TYPE=?,");
		sql.append(" POST_TYPE=?,");
		sql.append(" VAT_RATE=?,");
	...
	public static PreparedStatement getPrepareStmDelete(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" DELETE FROM ").append(TboACGL_VATSALE.tablename);
		sql.append(" WHERE COMP_CDE=? AND VOU_TYPE=? AND VOU_NO=? AND VOU_SEQ=? AND VOU_DSEQ=? ");
		return dbc.getPreparedStatement(sql.toString());
	}
	...
	public static PreparedStatement getPrepareStmFind(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" SELECT * FROM ").append(TboACGL_VATSALE.tablename);
		sql.append(" WHERE COMP_CDE=? AND VOU_TYPE=? AND VOU_NO=? AND VOU_SEQ=? AND VOU_DSEQ=? ");
		return dbc.getPreparedStatement(sql.toString());
	}

	public static void setPrepareStm(PreparedStatement pstm, TboACGL_VATSALE model) throws SQLException, Exception {
	...
	public static void setModel(ResultSet rs, TboACGL_VATSALE model) throws SQLException, Exception {
