...
public class TbfACCT_NO_SUB {
	public static boolean insert(TboACCT_NO_SUB model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return insert(dbc, model);
		}
	}

	public static boolean insert(FDbc dbc, TboACCT_NO_SUB model) throws SQLException, Exception {
	...
	public static boolean update(TboACCT_NO_SUB model, String fixWhere) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return update(dbc, model, fixWhere);
		}
	}

	public static boolean update(FDbc dbc, TboACCT_NO_SUB model, String fixWhere) throws SQLException, Exception {
	...
	public static boolean delete(TboACCT_NO_SUB model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return delete(dbc, model);
		}
	}

	public static boolean delete(FDbc dbc, TboACCT_NO_SUB model) throws SQLException, Exception {
	...
	public static boolean find(TboACCT_NO_SUB model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return find(dbc, model);
		}
	}

	public static boolean find(FDbc dbc, TboACCT_NO_SUB model) throws SQLException, Exception {
	...
	public static PreparedStatement getPrepareStmInsert(FDbc dbc) throws SQLException, Exception {
		...
		sql.append(" INSERT INTO ").append(TboACCT_NO_SUB.tablename).append("(");
		sql.append(" SUB_TYPE,");
		sql.append(" ACCT_ID_BANK,");
		sql.append(" INSBY,");
		sql.append(" INSDT,");
		sql.append(" UPBY,");
		sql.append(" UPDT,");
	...
	public static PreparedStatement getPrepareStmUpdate(FDbc dbc, String fixWhere) throws SQLException, Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" UPDATE ").append(TboACCT_NO_SUB.tablename).append(" SET ");
		sql.append(" SUB_TYPE=?,");
		sql.append(" ACCT_ID_BANK=?,");
		sql.append(" INSBY=?,");
		sql.append(" INSDT=?,");
	...
	public static PreparedStatement getPrepareStmDelete(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" DELETE FROM ").append(TboACCT_NO_SUB.tablename);
		sql.append(" WHERE COMP_CDE=? AND ACCT_ID=? ");
		return dbc.getPreparedStatement(sql.toString());
	}
	...
	public static PreparedStatement getPrepareStmFind(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" SELECT * FROM ").append(TboACCT_NO_SUB.tablename);
		sql.append(" WHERE COMP_CDE=? AND ACCT_ID=? ");
		return dbc.getPreparedStatement(sql.toString());
	}

	public static void setPrepareStm(PreparedStatement pstm, TboACCT_NO_SUB model) throws SQLException, Exception {
		pstm.clearParameters();
		pstm.setInt(1, model.getSUB_TYPE());
		pstm.setString(2, model.getACCT_ID_BANK());
	...
	public static void setModel(ResultSet rs, TboACCT_NO_SUB model) throws SQLException, Exception {
		model.setSUB_TYPE(rs.getInt("SUB_TYPE"));
		model.setACCT_ID_BANK(rs.getString("ACCT_ID_BANK"));
