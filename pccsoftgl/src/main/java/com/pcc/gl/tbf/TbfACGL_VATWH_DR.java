...
public class TbfACGL_VATWH_DR {
	public static boolean insert(TboACGL_VATWH_DR model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return insert(dbc, model);
		}
	}

	public static boolean insert(FDbc dbc, TboACGL_VATWH_DR model) throws SQLException, Exception {
	...
	public static boolean update(TboACGL_VATWH_DR model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return update(dbc, model);
		}
	}

	public static boolean update(FDbc dbc, TboACGL_VATWH_DR model) throws SQLException, Exception {
	...
	public static boolean update(TboACGL_VATWH_DR model, String fixWhere) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return update(dbc, model, fixWhere);
		}
	}

	public static boolean update(FDbc dbc, TboACGL_VATWH_DR model, String fixWhere) throws SQLException, Exception {
	...
	public static boolean delete(TboACGL_VATWH_DR model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return delete(dbc, model);
		}
	}

	public static boolean delete(FDbc dbc, TboACGL_VATWH_DR model) throws SQLException, Exception {
	...
	public static boolean find(TboACGL_VATWH_DR model) throws SQLException, Exception {
		try (FDbc dbc = FDbc.connectMasterDb()) {
			return find(dbc, model);
		}
	}

	public static boolean find(FDbc dbc, TboACGL_VATWH_DR model) throws SQLException, Exception {
	...
	public static PreparedStatement getPrepareStmInsert(FDbc dbc) throws SQLException, Exception {
		...
		sql.append(" INSERT INTO ").append(TboACGL_VATWH_DR.tablename).append("(");
		sql.append(" POSTDATE,");
		sql.append(" VAT_RATE,");
		sql.append(" NUM_TYPE,");
		sql.append(" AMT,");
	...
	public static PreparedStatement getPrepareStmUpdate(FDbc dbc, String fixWhere) throws SQLException, Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" UPDATE ").append(TboACGL_VATWH_DR.tablename).append(" SET ");
		sql.append(" POSTDATE=?,");
		sql.append(" VAT_RATE=?,");
		sql.append(" NUM_TYPE=?,");
		sql.append(" AMT=?,");
	...
	public static PreparedStatement getPrepareStmDelete(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" DELETE FROM ").append(TboACGL_VATWH_DR.tablename);
		sql.append(" WHERE COMP_CDE=? AND VOU_TYPE=? AND VOU_NO=? AND VOU_SEQ=? AND VOU_DSEQ=? ");
		return dbc.getPreparedStatement(sql.toString());
	}
	...
	public static PreparedStatement getPrepareStmFind(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" SELECT * FROM ").append(TboACGL_VATWH_DR.tablename);
		sql.append(" WHERE COMP_CDE=? AND VOU_TYPE=? AND VOU_NO=? AND VOU_SEQ=? AND VOU_DSEQ=? ");
		return dbc.getPreparedStatement(sql.toString());
	}

	public static void setPrepareStm(PreparedStatement pstm, TboACGL_VATWH_DR model) throws SQLException, Exception {
		pstm.clearParameters();
		pstm.setDate(1, model.getPOSTDATE());
		pstm.setBigDecimal(2, model.getVAT_RATE());
		pstm.setBigDecimal(3, model.getNUM_TYPE());
		pstm.setBigDecimal(4, model.getAMT());
		pstm.setBigDecimal(5, model.getBASE_AMT());
		pstm.setString(6, model.getSECT_ID());
		pstm.setString(7, model.getDESCR());
		pstm.setString(8, model.getDOCNO());
		pstm.setDate(9, model.getDOCDATE());
		pstm.setString(10, model.getCUST_CDE());
		pstm.setString(11, model.getCUST_NAME());
		pstm.setString(12, model.getRCVBY());
		pstm.setDate(13, model.getRCVDATE());
		pstm.setInt(14, model.getRECSTA());
	...
	public static void setModel(ResultSet rs, TboACGL_VATWH_DR model) throws SQLException, Exception {
		...
		model.setRCVBY(rs.getString("RCVBY"));
		model.setRCVDATE(rs.getDate("RCVDATE"));
