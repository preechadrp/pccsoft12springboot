...
public class TbfFPARA_COMP {
	...
	public static boolean insert(FDbc dbc, TboFPARA_COMP model) throws SQLException, Exception {
	...
	public static boolean update(FDbc dbc, TboFPARA_COMP model, String fixWhere) throws SQLException, Exception {
	...
	public static boolean delete(FDbc dbc, TboFPARA_COMP model) throws SQLException, Exception {
		try (PreparedStatement pstm = getPrepareStmDelete(dbc);) {
			pstm.setString(1, model.getCOMP_CDE());
			pstm.setString(2, model.getPARA_ID());
	...
	public static boolean find(FDbc dbc, TboFPARA_COMP model) throws SQLException, Exception {
	...
	public static PreparedStatement getPrepareStmInsert(FDbc dbc) throws SQLException, Exception {
		...
		sql.append(" INSERT INTO ").append(TboFPARA_COMP.tablename).append("(");
	...
	public static PreparedStatement getPrepareStmUpdate(FDbc dbc, String fixWhere) throws SQLException, Exception {
		StringBuffer sql = new StringBuffer();
		sql.append(" UPDATE ").append(TboFPARA_COMP.tablename).append(" SET ");
		sql.append(" PARA_VALUE=?");
		sql.append(" WHERE COMP_CDE=? AND PARA_ID=? ");
	...
	public static PreparedStatement getPrepareStmDelete(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" DELETE FROM ").append(TboFPARA_COMP.tablename);
		sql.append(" WHERE COMP_CDE=? AND PARA_ID=? ");
		return dbc.getPreparedStatement(sql.toString());
	}
	...
	public static PreparedStatement getPrepareStmFind(FDbc dbc) throws SQLException {
		StringBuffer sql = new StringBuffer();
		sql.append(" SELECT * FROM ").append(TboFPARA_COMP.tablename);
		sql.append(" WHERE COMP_CDE=? AND PARA_ID=? ");
		return dbc.getPreparedStatement(sql.toString());
	}

	public static void setPrepareStm(PreparedStatement pstm, TboFPARA_COMP model) throws SQLException, Exception {
	...
	public static void setModel(ResultSet rs, TboFPARA_COMP model) throws SQLException, Exception {
